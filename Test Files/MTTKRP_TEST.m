...
% % test case 4
% Z = tensor(rand(3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3));
% X = {rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5),rand(3,5)};
% N = 18;
...
for k = 1:numTimes
    ...
    for n = 1:N
        ...
        if n == 1
            ...
            W{n} = multiTTVResult(T,X(n+1:S-1));
